...
local function RenderToGlowTexture( entity )
	...
	render.SetRenderTarget( RT1 );
       ...
       if(entity:GetNWInt("Powerup", 1)) then col = Color( 200, 50, 50 ) end
       if(entity:GetNWInt("Powerup", 2)) then col = Color( 50, 50, 200 ) end
       if(entity:GetNWInt("Powerup", 3)) then col = Color( 217, 154, 0 ) end
       if(entity:GetNWInt("Powerup", 0)) then col = Color( 255, 0, 0) end
